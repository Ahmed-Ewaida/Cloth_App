    ...
    return Row(
      children: [
        ...
        Column(
          ...
          children: [
            Text("Matilda Brown",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
            Text("matildabrown@mail.com ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14,color: Color(0xff9B9B9B)),),
