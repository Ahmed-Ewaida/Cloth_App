        ...
        child:  Column(
           ...
           children: [
                ...
                Container(
                    ...
                    const Text("Mango", style: TextStyle(fontSize: 11, color: Color(0xff9B9B9B)),),
                    const SizedBox(height: 3),
                    const Text("Pullover",style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black),),
                    const SizedBox(height: 3),
                    const Text("17\$", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black),),
              ],
            ),
          ),
    ],
